...
sudo gzip windows.iso

sudo cp -v Clonezilla.iso Lenovo_BIOS_Update.iso Lenovo_Diagnostics.iso ubuntu-22.04.iso USBOX_V7.iso windows.iso.gz /mnt/usb

cd ../mnt/usb

sudo gunzip windows.iso.gz
